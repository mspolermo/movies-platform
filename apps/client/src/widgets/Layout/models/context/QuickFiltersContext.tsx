 ...
 */
export const QuickFiltersContext = createContext<TQuickFiltersResponse | null>(null);
...
export function QuickFiltersProvider({
  ...
  return <QuickFiltersContext.Provider value={value}>{children}</QuickFiltersContext.Provider>;
}
