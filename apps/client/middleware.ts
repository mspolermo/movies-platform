...
/**
 * Выполняется на сервере до рендера страницы.
 *
 ...
 *
 * Важно: `has_session` — только хинт для UI/middleware. Реальная защита
...
/** На каких маршрутах запускать middleware (остальные не трогаем). */
export const config = {
